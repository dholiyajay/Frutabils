        ...
        <div>
            ...
            <div className="container-fluid vesitable py-5">
                <div className="container py-5">
                    ...
                    <OwlCarousel {...fruite} OwlCarousel className="owl-carousel vegetable-carousel justify-content-center">
            ...
            <div className="container-fluid testimonial py-5">
                <div className="container py-5">
                    ...
                    <OwlCarousel {...vegetable} className="owl-carousel testimonial-carousel">
